...
import { SETTLEMENT_VERSION, isCurrentRegime, LEGACY_EXIT_POLICY } from './settlementVersion.js'
...
function effectiveHorizon(s: RecommendationSnapshot): number {
  return managedHoldDays(s.strategyId, s.dte, s.exitPolicy ?? LEGACY_EXIT_POLICY)
}
