 ...
 * card. It does NOT fix the reward↔$ inversion (out of scope here — that needs
 * the reward-formula change on fix/condor-reward-formula). This file only
 * asserts the wing geometry and the variant epoch.
 *
